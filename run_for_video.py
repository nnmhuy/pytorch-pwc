...
# change this if you have a multiple graphics cards and you want to utilize them
torch.cuda.device(1)
...
class Network(torch.nn.Module):
	def __init__(self):
		...
		self.load_state_dict(torch.load(
			'./network-' + arguments_strModel + '.pytorch'))
	# end
...
for i in range(33, 50):
	...
	while(cap.isOpened()):
		...
		arguments_strOut = '/content/drive/My Drive/AIC_2019_Train_Cut_abs(1)/flow/%d/flow%d.flo' % (i, index)
		# arguments_strOut = './out.flo'
